...
#[derive(Debug)]
pub struct RouteHandlerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RouteHandlerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RouteHandler processing");
    
    let mut processor = RouteHandlerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RouteHandlerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RouteHandlerProcessor::new(false);
